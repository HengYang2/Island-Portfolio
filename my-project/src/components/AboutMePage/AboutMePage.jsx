...
export default function AboutMePage() {
    ...
    function conditionallyRenderText() {
        switch (selectedQuestion) {
            ...
            case 'option2':
                return <p onClick={() => { setSelectedQuestion(''); setQuestionsVisable(true) }} className='relative bg-white left-0 w-4/5 top-1.5 h-40 p-2 border border-black rounded-md box-shado'>You are on Paradise Island, a place created from my imagination. You are expereiencing a piece of my mind!</p>
            case 'option3':
